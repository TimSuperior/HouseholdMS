...
namespace HouseholdMS.Database
{
    public static class DatabaseInitializer
    {
        private static readonly string DbFilePath = Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "household_management.db");
        ...
        public static void Initialize()
        {
            ...
            {
                Console.WriteLine($"ℹ️ Database already exists at: {DbFilePath}");
            }
        }
